...
Public Class LumiraDocument
    ...
    Public Function ExtractXliff() As Boolean Implements iXliff.ExtractXliff
        'Mod
        Try
            If Lums_DocumentProcess.LumiraDocumentExtractXliff(_sFile, CPS.Xliff_FileInTobetransalted, CPS.CurrentLang) <> "" Then
    ...
    Public Sub CreateOutFile() Implements iXliff.CreateOutFile
        Try
            Lums_DocumentProcess.LumiraDocumentReIntegrate(CPS.Xliff_FileInBackFromtranslation, _sFile, CPS.OutFile, CPS.CurrentLang)
